...
class ArchitecteTestBool {
    ...
    private final Architecte objetBoolArchitecteCycle1 =
            new Architecte("src/test/resources/FichierTestMethodeBool/ValiderActivitesBoolArchitecteCycle1.json", jsonObj);
    private final Architecte objetBoolArchitecteCycle2 =
            new Architecte("src/test/resources/FichierTestMethodeBool/ValiderActivitesBoolArchitecteCycle2.json", jsonObj);
    private final Architecte objetBoolArchitecteCycle3 =
            new Architecte("src/test/resources/FichierTestMethodeBool/ValiderActivitesBoolArchitecteCycle3.json", jsonObj);
    private final Architecte objetBoolArchitecteCycleInvalide =
            new Architecte("src/test/resources/FichierTestMethodeBool/ValiderActivitesBoolArchitecteCycleInvalide.json", jsonObj);
