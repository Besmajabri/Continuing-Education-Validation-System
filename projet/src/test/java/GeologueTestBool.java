...
class GeologueTestBool {
    ...
    private final Geologue objetBoolGeologueCycle1 =
            new Geologue("src/test/resources/FichierTestMethodeBool/ValiderActivitesBoolGeologueCycle1.json", jsonObj);

    private final Geologue objetBoolGeologueCycleInvalide =
            new Geologue("src/test/resources/FichierTestMethodeBool/ValiderActivitesBoolGeologueCycleInvalide.json", jsonObj);
