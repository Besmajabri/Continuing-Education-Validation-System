...
class PsychologueTestDateEtCycle {
    ...
    private final Psychologue objetBoolPsychologueCycle1 =
            new Psychologue ("src/test/resources/FichierTetMethodeDateCycle/ValiderActivitesBoolPsychologueCycle1.json", jsonObj);

    private final Psychologue objetBoolPsychologueCycleInvalide =
            new Psychologue("src/test/resources/FichierTetMethodeDateCycle/ValiderActivitesBoolPsychologueCycleInvalide.json", jsonObj);
